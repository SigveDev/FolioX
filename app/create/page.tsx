  ...
  const creationTypes = [
    {
      ...
      name: "Portfolio",
      description:
        "Create a complete professional portfolio with your bio, experience, and selected projects",
      icon: User,
      features: [
    ...
    },
    {
      ...
      description:
        "Showcase a single project with images, descriptions, and key highlights",
      icon: Presentation,
      features: [
        "Project overview",
        "Image galleries",
    ...
    },
    {
      ...
      name: "Case Study",
      description:
        "Create detailed, story-driven case studies with research, process, and results",
      icon: FileText,
      features: [
